...
import { Contact2, Plus, Users, CheckCircle2, XCircle } from 'lucide-react'
    ...
    <HrModal
      ...
      footer={(
        <>
          ...
          <HrModalSubmit form="hr-desig-form" loading={loading}>
    ...
    >
      <form id="hr-desig-form" onSubmit={submit} className="space-y-3">
        <HrField label="Name" required>
          <input required className="input-field h-11 w-full" placeholder="e.g. Senior Technician" value={form.name} onChange={e => setForm(p => ({ ...p, name: e.target.value }))} autoFocus />
        </HrField>
        <div className="grid grid-cols-2 gap-3">
          <HrField label="Code" hint="Optional short code">
            <input className="input-field h-11 w-full font-mono" placeholder="SR-TECH" value={form.code} onChange={e => setForm(p => ({ ...p, code: e.target.value }))} />
          </HrField>
