...
export function getExpectedImeiCount(po: PurchaseOrder, products: PoProduct[]) {
...
export function poHasImeiProducts(po: PurchaseOrder, products: PoProduct[]) {
  return getExpectedImeiCount(po, products) > 0
}

export function poCanRegisterImei(po: PurchaseOrder, products: PoProduct[]) {
...
/* â”€â”€ IMEI Register Modal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
export function IMEIRegisterModal({ po, products, onClose, onSaved }: {
  po: PurchaseOrder
  products: PoProduct[]
  onClose: () => void
