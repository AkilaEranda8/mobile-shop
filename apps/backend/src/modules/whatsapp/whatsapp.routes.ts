...
router.put('/config',              authorize('OWNER', 'MANAGER', 'CASHIER', 'TECHNICIAN'), validate(updateConfigSchema),     whatsappController.updateConfig)
router.post('/test',               authorize('OWNER', 'MANAGER', 'CASHIER', 'TECHNICIAN'),                                   whatsappController.testConnection)
router.post('/test-message',       authorize('OWNER', 'MANAGER', 'CASHIER', 'TECHNICIAN'), validate(sendTestMessageSchema),  whatsappController.sendTestMessage)
