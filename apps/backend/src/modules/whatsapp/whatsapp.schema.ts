...
/** Strip spaces/dashes/parens so numbers like "+94 75 75 16 772" validate. */
function sanitizePhoneInput(val: unknown): unknown {
...
const phoneSchema = z.preprocess(
  sanitizePhoneInput,
  z.string().regex(/^\+?[0-9]\d{6,14}$/, 'Invalid phone number'),
)
