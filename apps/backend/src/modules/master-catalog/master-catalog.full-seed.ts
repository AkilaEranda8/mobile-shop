...
const PHONE_MODELS: Record<string, Array<{ name: string; tier: StorageTier; year: number }>> = {
  Samsung: [
    { name: 'Galaxy A05', tier: 'budget', year: 2023 },
    { name: 'Galaxy A06', tier: 'budget', year: 2024 },
    { name: 'Galaxy A15', tier: 'budget', year: 2024 },
    { name: 'Galaxy A16', tier: 'budget', year: 2025 },
    { name: 'Galaxy A25', tier: 'budget', year: 2024 },
    { name: 'Galaxy A26', tier: 'budget', year: 2025 },
    { name: 'Galaxy A35', tier: 'mid', year: 2024 },
    { name: 'Galaxy A36', tier: 'mid', year: 2025 },
    { name: 'Galaxy A55', tier: 'mid', year: 2024 },
    { name: 'Galaxy A56', tier: 'mid', year: 2025 },
    { name: 'Galaxy S24', tier: 'flagship', year: 2024 },
    { name: 'Galaxy S24+', tier: 'flagship', year: 2024 },
    { name: 'Galaxy S24 Ultra', tier: 'flagship', year: 2024 },
  ...
  Apple: [
    { name: 'iPhone SE (3rd gen)', tier: 'budget', year: 2022 },
    { name: 'iPhone 11', tier: 'budget', year: 2019 },
    { name: 'iPhone 11 Pro', tier: 'mid', year: 2019 },
    { name: 'iPhone 11 Pro Max', tier: 'mid', year: 2019 },
    { name: 'iPhone 12', tier: 'budget', year: 2020 },
    { name: 'iPhone 12 mini', tier: 'budget', year: 2020 },
    { name: 'iPhone 12 Pro', tier: 'mid', year: 2020 },
    { name: 'iPhone 12 Pro Max', tier: 'mid', year: 2020 },
    { name: 'iPhone 13', tier: 'budget', year: 2021 },
    { name: 'iPhone 13 mini', tier: 'budget', year: 2021 },
    { name: 'iPhone 13 Pro', tier: 'mid', year: 2021 },
    { name: 'iPhone 13 Pro Max', tier: 'mid', year: 2021 },
    { name: 'iPhone 14', tier: 'mid', year: 2022 },
    { name: 'iPhone 14 Plus', tier: 'mid', year: 2022 },
    { name: 'iPhone 14 Pro', tier: 'flagship', year: 2022 },
    { name: 'iPhone 14 Pro Max', tier: 'flagship', year: 2022 },
    ...
    { name: 'iPhone 16e', tier: 'budget', year: 2025 },
  ],
  Xiaomi: [
