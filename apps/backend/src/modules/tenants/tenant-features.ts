export const ALL_FEATURES: string[] = [
  ...
  'DAILY_RELOAD', 'CUSTOMER_CREDIT', 'DAILY_CLOSING', 'PROFIT_ALLOCATION',
]

export const OPT_IN_FEATURES: string[] = ['DAILY_RELOAD', 'CUSTOMER_CREDIT', 'DAILY_CLOSING', 'PROFIT_ALLOCATION']
